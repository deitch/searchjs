...
searches = [
	...
	{search: {empty:undefined}, results:[0,2,3,4,5]} ,
	...
	{search: {name:"alice",_not: true}, results:[1,2,3,5]},
	{search: {male:true}, results:[1,3]},
	{search: {age:30,male:true}, results:[1]},
	{search: {male:true,_not:true}, results:[0,2,4,5]},
	...
	{search: {age:35, name: "Alice", _not: true},results: [1,2,5]},
	...
	{search: {_not: true, name: ["Brian","Carrie"]},results: [0,3,4,5]},
	{search: {_not:true, email: ["alice@searchjs.com","carrie@searchjs.com"]},results: [1,3,5]},
	{search: {city:"Montreal"},results:[0,2]},
	{search: {_not:true,city:"Montreal"},results:[1,3,4,5]},
	...
	{search: {_not:true,age:{to:29}},results:[1,2,3,4,5]},
	{search: {_not:true,age:{from:30,to:34}},results:[0,3,5]},
